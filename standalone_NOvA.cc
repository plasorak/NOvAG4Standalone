...
#include "QBBC.hh"
//#include "G4PhysListFactory.hh"   // alternative version in "g4nu" namespace
...
// #endif
  ...
  NOvADetectorConstruction* det = new NOvADetectorConstruction;
  ...
  runManager->SetUserInitialization(new NOvAActionInitialization(det));
