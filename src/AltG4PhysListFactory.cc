...
// ********************************************************************
//
// $Id: AltG4PhysListFactory.cc,v 1.1.1.1 2011-12-06 17:49:40 rhatcher Exp $
...
#include "AltG4PhysListFactory.hh"
...
void G4PhysListFactory::PrintAvailableLists() const
{
  // return list of known names
  return G4PhysListFactorySingleton::Instance().PrintAvailableLists();
}
